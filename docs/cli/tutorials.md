...
This page contains tutorials for interacting with LLMs Code.
...
LLMs Code uses this value in the `mcpServers` configuration that you defined in the `settings.json` file.

#### Launch Gemini CLI and verify the connection

When you launch LLMs Code, it automatically reads your configuration and launches the GitHub MCP server in the background. You can then use natural language prompts to ask LLMs Code to perform GitHub actions. For example:
