...
export const GEMINI_CONFIG_DIR = '.llms-code';
export const DEFAULT_CONTEXT_FILENAME = 'LLMS-CODE.md';
export const MEMORY_SECTION_HEADER = '## LLMs Code Added Memories';

// This variable will hold the currently configured filename for LLMS-CODE.md context files.
